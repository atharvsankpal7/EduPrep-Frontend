...
//   const [selectedTest, setSelectedTest] = useState<TestDetailResult | null>(
//     null
//   );
...
//         `${BACKEND_URL}/test-history?page=${page}&limit=10`,
//         {
...
//     try {
//       const response = await axios.get(
//         `${BACKEND_URL}/test-history/analytics`,
//         {
//           withCredentials: true,
//         }
//       );
...
//       setLoading(true);
//       const response = await axios.get(
//         `${BACKEND_URL}/test-history/${resultId}`,
//         {
//           withCredentials: true,
//         }
//       );
...
//       case "name":
//         sorted.sort((a, b) =>
//           a.testDetails.testName.localeCompare(b.testDetails.testName)
//         );
//         break;
//     }
...
//                           </div>
//                           <Badge
//                             className={getScoreBadge(result.percentageScore)}
//                           >
...
//                               <span>
//                                 {result.score} /{" "}
//                                 {result.testDetails.totalQuestions} correct
//                               </span>
//                             </div>
//                             <div className="flex items-center text-sm text-muted-foreground">
...
//                             ? format(
//                                 new Date(analytics.recentTests[0].createdAt),
//                                 "MMM d"
//                               )
//                             : "No tests"}
//                         </div>
...
//                       <CardDescription>
//                         Based on your test performance, here are areas you
//                         should focus on
//                       </CardDescription>
//                     </CardHeader>
//                     <CardContent>
...
//                               </div>
//                               <Badge
//                                 className={getScoreBadge(test.percentageScore)}
//                               >
...
//                         <div>
//                           <CardTitle>
//                             {selectedTest.testResult.testName}
//                           </CardTitle>
//                           <CardDescription>
//                             Taken on{" "}
//                             {format(
//                               new Date(selectedTest.testResult.createdAt),
//                               "PPP 'at' p"
//                             )}
//                           </CardDescription>
//                         </div>
...
//                             selectedTest.testResult.percentageScore
//                           )}
//                         >
...
//                             {selectedTest.testResult.score} /{" "}
//                             {selectedTest.testResult.totalQuestions}
//                           </span>
//                         </div>
//                         <div className="flex flex-col">
//                           <span className="text-sm text-muted-foreground">
